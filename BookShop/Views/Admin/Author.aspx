        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="mb-3">
                   ...
                   <asp:DropDownList  runat="server" class="form-control" id="GenCb" OnSelectedIndexChanged="GenCb_SelectedIndexChanged">
            ...
            <div class="col-md-8">
                <asp:GridView ID="AuthorsList" runat="server" class="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="AuthorsList_SelectedIndexChanged">
