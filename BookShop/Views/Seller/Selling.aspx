<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Seller/Seller.Master" AutoEventWireup="true" CodeBehind="Selling.aspx.cs" Inherits="BookShop.Views.Seller.Selling" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                 <div class="col-md-5">
                     <h3 class="text-success" style="color:teal" >Book Details</h3>
                     <div class="row">
                      <div class="col">
                      <div class="mt-3">
                      <label for="" class="form-label text-success" >Book Name</label>
                      <input type="text" placeholder="Book's Name" autocomplete="off" runat="server" id="BNameTb" class="form-control"/>
                       </div>
                      </div>
                      <div class="col">
                      <div class="mt-3">
                     ...
                     <div class="row mt-5">
                     <h4 class="text-success" style="color:teal" >Book List</h4>
                    <div class="col">
                   <asp:GridView ID="BooksList" runat="server" class="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="AuthorsList_SelectedIndexChanged">
                 ...
                 <div class="col-md-7">
                      <h4 class="text-success" style="color:crimson" >Client's Bill</h4>
                    <div class="col">
                   <asp:GridView ID="BillList" runat="server" class="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="AuthorsList_SelectedIndexChanged">
                    <AlternatingRowStyle BackColor="White" />
                    <EditRowStyle BackColor="#7C6F57" />
                    <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
